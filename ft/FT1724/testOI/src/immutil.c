...
#if 0
/*LLDTEST remove*/
void ccbutil_ccbAddDeleteOperation_2(struct CcbUtilCcbData *ccb,
		const SaNameT *objectName,
		const SaNameT *otherName)
{
	struct Chunk *clist = (struct Chunk *)ccb->memref;
...
int ccbutil_ccbAddModifyOperation(struct CcbUtilCcbData *ccb, const SaNameT *objectName,
...
int ccbutil_ccbAddModifyOperation_2(struct CcbUtilCcbData *ccb,
					const SaNameT *objectName,
					const SaNameT *otherName,
					const SaImmAttrModificationT_2 **attrMods)
{
