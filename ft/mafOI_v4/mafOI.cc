...
*   MafOamSpiRegisterObjectImplementer_1, MafMgmtSpiThreadContext_2, MafOamSpiTransaction_2 interfaces from the COM SPI Interface portal
*
*	 Modified: eozasaf 2011-09-02 Implemented the MafOamSpiManagedObject_1T and MafOamSpiTransactionalResource_2T interfaces as mocks
*
...
MafMgmtSpiComponent_2T component;
MafMgmtSpiInterfacePortal_3T* _portal;
MafMgmtSpiInterface_1T* dependencyArray[2];
MafMgmtSpiInterface_1T* interfaceArray[3];
MafMgmtSpiThreadContext_2T* _threadContextIf;
MafMwSpiLog_1T* _logServiceIf;
MafMwSpiTrace_1T* _traceServiceIf;
MafNameValuePairT ** filter_from_addFilter;
MafOamSpiEventRouter_1T* _eventRouter;
MafOamSpiManagedObject_3T managedObjectIf;
MafOamSpiRegisterObjectImplementer_3T* _registerObjectImplementerIf;
MafOamSpiTransaction_2T * _transactionIf;
MafOamSpiTransactionalResource_2T transactionalResourceIf;
#ifndef ALARMS4
...
MafOamSpiTransactionHandleT hs99358_current_txhandle_id = 0;
...
MafReturnT registerAsOIToOamSA(std::string, OIaction, std::string);
...
typedef std::pair<MafOamSpiTransactionHandleT, MafMoAttributeValueContainer_3T *> deletePairType;
typedef std::map<MafOamSpiTransactionHandleT, MafMoAttributeValueContainer_3T *> deleteMapType;
...
*/
bool saveToDeleteList(MafOamSpiTransactionHandleT txHandle, MafMoAttributeValueContainer_3T * pContainer)
{
	bool ret = true;
...
void freeContainer(MafMoAttributeValueContainer_3T * cnt)
{
	...
	if(cnt->type != MafOamSpiMoAttributeType_3_STRUCT)
	{
		...
		if(cnt->values)
		{
			...
			else if(cnt->type == MafOamSpiMoAttributeType_3_REFERENCE)
			{
				for(unsigned int i=0; i<cnt->nrOfValues; i++)
				{
...
*     Else: write a syslog
*/
void freeDeleteList(MafOamSpiTransactionHandleT txHandle)
{
...
static MafReturnT addFilter(MafOamSpiEventConsumerHandleT consumerHandle, const char * eventType, MafNameValuePairT ** filter)
{
	...
	syslog(LOG_INFO, "%s addFilter(): LEAVE: returning MafOk",log_prefix);
	return MafOk;
}
...
static MafReturnT removeFilter(MafOamSpiEventConsumerHandleT consumerHandle, const char * eventType, MafNameValuePairT ** filter)
{
	...
	syslog(LOG_INFO, "%s removeFilter(): LEAVE: returning MafOk",log_prefix);
	return MafOk;
}
...
static MafReturnT clearAll(void)
{
	...
	syslog(LOG_INFO, "%s clearAll(): LEAVE: returning MafOk",log_prefix);
	return MafOk;
}
...
static MafReturnT doneWithValue(const char *eventType, void * value)
{
	...
	syslog(LOG_INFO, "%s doneWithValue(): LEAVE: returning MafOk",log_prefix);
	return MafOk;
}
#endif
...
std::string findTypeForSetMO(MafMoAttributeValueStructMember_3 * struct_Member)
{
	...
	{
	case MafOamSpiMoAttributeType_3_INT8:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_INT8 type entered",log_prefix);
		Type_And_Value = "INT8 = ";
		...
		break;
	case MafOamSpiMoAttributeType_3_INT16:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_INT16 type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_INT32:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_INT32 type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_INT64:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_INT64 type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_UINT8:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_UINT8 type entered",log_prefix);
		...
		for(unsigned int i = 0; i < struct_Member->memberValue->nrOfValues; i++)
		{
			...
			if ((flag_mr20275) and (struct_Member->memberValue->values[i].value.u8 == 13))
			{
				...
				_threadContextIf->addMessage(ThreadContextMsgNbi_2, errorText.c_str());
		...
		break;
	case MafOamSpiMoAttributeType_3_UINT16:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_UINT16 type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_UINT32:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_UINT32 type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_UINT64:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_UINT64 type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_DECIMAL64:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_DECIMAL64 type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_STRING:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_STRING type entered",log_prefix);
		...
		break;
	case MafOamSpiMoAttributeType_3_BOOL:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_BOOL type entered",log_prefix);
		Type_And_Value = "BOOL = ";
		for(unsigned int i = 0; i < struct_Member->memberValue->nrOfValues; i++)
		{
			char charBuffer[1000];
		...
		break;
	case MafOamSpiMoAttributeType_3_ENUM:
		syslog(LOG_INFO, "%s MO::setMoAttribute(): findTypeForSetMO: MafOamSpiMoAttributeType_3_ENUM type entered",log_prefix);
		Type_And_Value = "ENUM = ";
		for(unsigned int i = 0; i < struct_Member->memberValue->nrOfValues; i++)
		{
			char charBuffer[1000];
...
std::string getAttrsFromStructForSetMO(MafMoAttributeValueStructMember_3 * StructMember)
{
...
void prepareContainer(MafOamSpiMoAttributeType_3T attrType, int numOfValues, MafMoAttributeValueContainer_3T ** result)
{
	*result = new MafMoAttributeValueContainer_3T;
	...
	(*result)->values = new MafMoAttributeValue_3T[numOfValues];
}
...
MafOamSpiMoAttributeType_3T findTypeForStructAttr(std::string type)
{
	MafOamSpiMoAttributeType_3T ret;
	if     (type == "INT8")  {ret = MafOamSpiMoAttributeType_3_INT8;}
	else if(type == "INT16") {ret = MafOamSpiMoAttributeType_3_INT16;}
	else if(type == "INT32") {ret = MafOamSpiMoAttributeType_3_INT32;}
	else if(type == "INT64") {ret = MafOamSpiMoAttributeType_3_INT64;}
	else if(type == "UINT8") {ret = MafOamSpiMoAttributeType_3_UINT8;}
	else if(type == "UINT16"){ret = MafOamSpiMoAttributeType_3_UINT16;}
	else if(type == "UINT32"){ret = MafOamSpiMoAttributeType_3_UINT32;}
	else if(type == "UINT64"){ret = MafOamSpiMoAttributeType_3_UINT64;}
	else if(type == "DECIMAL64"){ret = MafOamSpiMoAttributeType_3_DECIMAL64;}
	else if(type == "STRING"){ret = MafOamSpiMoAttributeType_3_STRING;}
	else if(type == "BOOL")  {ret = MafOamSpiMoAttributeType_3_BOOL;}
	else if(type == "ENUM")  {ret = MafOamSpiMoAttributeType_3_ENUM;}
	else if(type == "MOREF") {ret = MafOamSpiMoAttributeType_3_REFERENCE;}
	else
	{
...
void fillContainerWithStructAttrValues(MafOamSpiMoAttributeType_3T attrType, std::string attrValue, MafMoAttributeValue_3 *containerValue)
{
	switch(attrType)
	{
	case MafOamSpiMoAttributeType_3_INT8:
...
MafReturnT notify(std::string dn, unsigned long int majorType, unsigned long int minorType, std::string additionalText, std::string severity_string, unsigned long long eventTime, std::string additionalInfo)
{
...
MafReturnT testComponentControl(std::string command)
{
	...
	else if(command.substr(0,5) == "ALARM")
	{
		if(!alarmsDefined)
		{
			syslog(LOG_INFO, "%s ERROR: controlling alarms without alarm configuration, returning MafFailure",log_prefix);
			return MafFailure;
		}
		spaceFilter(command);
	...
	else if(command.substr(0,3) == "LOG")
	{
		...
		{
			syslog(LOG_INFO, "%s ERROR: controlling log service functions without log service configuration, returning MafFailure",log_prefix);
			return MafFailure;
		}
		...
		{
			syslog(LOG_INFO, "%s logWrite(): Bad severity type: (%s), returning MafFailure",log_prefix, severity_string.c_str());
			return MafFailure;
		}
...
void setAllReturnValuesToFail()
{
	...
	// so all functions that called from outside will return MafFailure
#if !defined(SKIP_ERROR)
	{
		// Create a structure of return values
		functionReturnValues returnValues;
		returnValues.createMo = MafFailure;
		returnValues.deleteMo = MafFailure;
		returnValues.setMo    = MafFailure;
		returnValues.getMo    = MafFailure;
		returnValues.action   = MafFailure;
		returnValues.join     = MafFailure;
		returnValues.prepare  = MafFailure;
		returnValues.commit   = MafFailure;
		returnValues.finish   = MafFailure;
		returnValues.abort    = MafFailure;
		returnValues.validate = MafFailure;

		syslog(LOG_INFO, "%s setAllReturnValuesToFail(): ERROR case: setting MafFailure for return values",log_prefix);
...
static void UNUSED_FUNCTION(dummyReleaseMany)(MafMoAttributeValueContainer_3T **containers)
{
...
***************************************************************************************************************
*
*  MafOamSpiManagedObject_3T interface functions
*
***************************************************************************************************************
***************************************************************************************************************
***************************************************************************************************************/
MafReturnT maf_setMoAttribute(MafOamSpiTransactionHandleT txHandle, const char * dn, const char * attributeName, const MafMoAttributeValueContainer_3T * attributeValueContainer)
{
	...
	if (attributeValueContainer!=NULL) {
		...
		case MafOamSpiMoAttributeType_3_STRUCT:
			syslog(LOG_INFO, "%s MO::maf_setMoAttribute(): MafOamSpiMoAttributeType_3_STRUCT ENTERED",log_prefix);
			syslog(LOG_INFO, "%s MO::maf_setMoAttribute(): dn %s attributeName %s txHandle %lu",log_prefix,dn,attributeName,txHandle);
			syslog(LOG_INFO, "%s MO::maf_setMoAttribute(): MafOamSpiMoAttributeType_3_STRUCT nrOfValues: %u",log_prefix, attributeValueContainer->nrOfValues);
			if(attributeValueContainer->values->value.structMember == NULL)
			{
				syslog(LOG_INFO, "%s MO::maf_setMoAttribute(): MafOamSpiMoAttributeType_3_STRUCT is NULL",log_prefix);
				return MafFailure;
			}
		...
		case MafOamSpiMoAttributeType_3_ENUM:
			...
			break;
		case MafOamSpiMoAttributeType_3_REFERENCE:
			syslog(LOG_INFO, "%s MO::maf_setMoAttribute(): MafOamSpiMoAttributeType_3_REFERENCE ENTERED",log_prefix);
			break;
	...
	MafReturnT permissionReturnValue = testConfig->maf_getRegistration(_threadContextIf, dn);
	if(permissionReturnValue != MafOk)
	{
	...
	/* If a preconfigured return value is already set, then return that value instead of MafOk.
	* That means it is:
	*                    -an unexpected callback
	*                    -or a negative testcase where we especially set the return value other then MafOk
	*/
	MafReturnT retValue;
...
MafReturnT maf_getMoAttribute(MafOamSpiTransactionHandleT txHandle, const char * dn, const char * attributeName, MafMoAttributeValueResult_3T * result)
{
	...
	MafMoAttributeValueContainer_3T** cont_result = &(result->container);
	...
	*/
	...
	case MafOamSpiMoAttributeType_3_STRUCT:
		syslog(LOG_INFO, "%s MO::maf_getMoAttribute() MafOamSpiMoAttributeType_3_STRUCT type ENTER",log_prefix);
		...
		syslog(LOG_INFO, "%s MO::maf_getMoAttribute() MafOamSpiMoAttributeType_3_STRUCT nrOfValues: %i",log_prefix, MultiStructVector.size());

		// For all the structs fill in the container
		for(unsigned int m = 0; m < MultiStructVector.size(); m++)
		{
			MafMoAttributeValueStructMember_3T * tempStruct;
			// allocate memory for the struct
			(*cont_result)->values[m].value.structMember = NULL; // new MafMoAttributeValueStructMember_3T;
			...
			MafMoAttributeValueStructMember_3T * temp;
			for(unsigned int s = 0; s < MultiStructVector[m].size(); s++)
			{
				temp = new MafMoAttributeValueStructMember_3T;
				memset(temp, 0, sizeof(MafMoAttributeValueStructMember_3T));
				temp->next = NULL;
				...
				tempStruct->memberValue = new MafMoAttributeValueContainer_3T;
				// Set the type
				...
				tempStruct->memberValue->values = new MafMoAttributeValue_3T[tempStruct->memberValue->nrOfValues];
	...
	case MafOamSpiMoAttributeType_3_STRING:
		syslog(LOG_INFO, "%s MO::maf_getMoAttribute() type %i entered",log_prefix, theAttribute.attrType);
		*cont_result = new MafMoAttributeValueContainer_3T;
		...
		(*cont_result)->values = new MafMoAttributeValue_3T[1];
	...
	default:
		syslog(LOG_INFO, "%s MO::maf_getMoAttribute() type not found, returning MafFailure",log_prefix);
	...
	syslog(LOG_INFO, "%s MO::getMoAttribute() return MafOk",log_prefix);
	return MafOk;
}
...
MafReturnT maf_createMo(MafOamSpiTransactionHandleT txHandle, const char * parentDn, const char * className, const char * keyAttributeName, const char * keyAttributeValue, MafMoNamedAttributeValueContainer_3T ** initialAttributes)
{
	...
	retValue = testConfig->maf_getRegistration(_threadContextIf, parentDn, className, keyAttributeName);

	// If retValue not MafOk then return
	if(retValue != MafOk)
	{
	...
	*/
	...
	// If retValue not MafOk then write return value to syslog
	if(retValue != MafOk)
	{
		setAllReturnValuesToFail();
		syslog(LOG_INFO, "%s MO::createMo() returning (%i)",log_prefix, retValue);
...
MafReturnT maf_deleteMo(MafOamSpiTransactionHandleT txHandle, const char * dn)
{
	...
	MafReturnT retValue;
	// Check the DN's or MOC's permission in testConfig
	retValue = testConfig->maf_getRegistration(_threadContextIf, dn);
...
MafReturnT maf_action(MafOamSpiTransactionHandleT txHandle, const char * dn, const char * name, MafMoNamedAttributeValueContainer_3T **parameters, MafMoAttributeValueResult_3T * result)
{
	...
	MafMoAttributeValueContainer_3T **cont_parameters;
	MafMoNamedAttributeValueContainer_3T **pP = parameters;
	//SDP872 changes
	MafMoAttributeValueContainer_3T *sdp872_parameters;
	//mr24146 changes
	MafMoAttributeValueContainer_3T *mr24146_parameters;
	...
	cont_parameters = new MafMoAttributeValueContainer_3T*[i+1];
	...
	if(actionName == "testReturnMultiBool") {
		...
		sdp872_parameters = new MafMoAttributeValueContainer_3T;

		if (sdp872_parameters != NULL)
		{
			sdp872_parameters->values 				= new MafMoAttributeValue_3T[4];
			if (sdp872_parameters->values != NULL)
			{

				sdp872_parameters->type = MafOamSpiMoAttributeType_3_BOOL;
		...
		if (sdp872_parameters != NULL)
		{
			sdp872_parameters->values 				= new MafMoAttributeValue_3T[1];
			if (sdp872_parameters->values != NULL)
			{
				sdp872_parameters->type = MafOamSpiMoAttributeType_3_INT32;
		...
		if (sdp872_parameters != NULL)
		{
			sdp872_parameters->values 				= new MafMoAttributeValue_3T[3];
			if (sdp872_parameters->values != NULL)
			{
				sdp872_parameters->type = MafOamSpiMoAttributeType_3_INT32;
		...
		if (sdp872_parameters != NULL)
		{
			...
			if (sdp872_parameters->values != NULL)
			{
				...
				sdp872_parameters->type = MafOamSpiMoAttributeType_3_STRING;
				sdp872_parameters->nrOfValues = 1;
		...
		if (sdp872_parameters != NULL)
		{
			...
			if (sdp872_parameters->values != NULL)
			{
				sdp872_parameters->type = MafOamSpiMoAttributeType_3_STRUCT;
				sdp872_parameters->nrOfValues = 1;

				sdp872_parameters->values[0].value.structMember = new MafMoAttributeValueStructMember_3T;
				memset(sdp872_parameters->values[0].value.structMember, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				sdp872_parameters->values[0].value.structMember->memberValue = new MafMoAttributeValueContainer_3;
				...
				sdp872_parameters->values[0].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				sdp872_parameters->values[0].value.structMember->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				sdp872_parameters->values[0].value.structMember->next = new MafMoAttributeValueStructMember_3T;
				memset(sdp872_parameters->values[0].value.structMember->next, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				sdp872_parameters->values[0].value.structMember->next->memberValue = new MafMoAttributeValueContainer_3;
				...
				sdp872_parameters->values[0].value.structMember->next->memberValue->type = MafOamSpiMoAttributeType_3_INT32;

				sdp872_parameters->values[0].value.structMember->next->memberValue->values = new MafMoAttributeValue_3T[1];
		...
		if (sdp872_parameters != NULL)
		{
			...
			if (sdp872_parameters->values != NULL)
			{
				...
				sdp872_parameters->values[0].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				sdp872_parameters->values[0].value.structMember->memberValue->values = new MafMoAttributeValue_3[3];
				...
				sdp872_parameters->values[0].value.structMember->next->memberValue->values = new MafMoAttributeValue_3T[4];
		...
		if (sdp872_parameters != NULL)
		{
			...
			if (sdp872_parameters->values != NULL)
			{
				MafMoAttributeValueStructMember_3T *StructMemberPtr;
				...
				sdp872_parameters->values[0].value.structMember->memberValue->nrOfValues = 1;
				sdp872_parameters->values[0].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_BOOL;
				sdp872_parameters->values[0].value.structMember->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				StructMemberPtr = new MafMoAttributeValueStructMember_3T;
				memset(StructMemberPtr, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				StructMemberPtr->memberValue = new MafMoAttributeValueContainer_3;
				...
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_INT16;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				//Create new member in structure
				StructMemberPtr->next = new MafMoAttributeValueStructMember_3T;
				memset(StructMemberPtr->next, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				// Create INT32 value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_INT32;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create INT64 value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_INT64;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create INT8 value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_INT8;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create STRING value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create UINT16 value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_UINT16;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create UINT32 value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_UINT32;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create UINT64 value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_UINT64;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create UINT8 value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_UINT8;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				// Create ENUM value
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_ENUM;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				StructMemberPtr->memberValue->nrOfValues = 1;
				StructMemberPtr->memberValue->type = MafOamSpiMoAttributeType_3_REFERENCE;
				StructMemberPtr->memberValue->values = new MafMoAttributeValue_3T[1];
		...
		if (sdp872_parameters != NULL)
		{
			sdp872_parameters->values 				= new MafMoAttributeValue_3T[2];
			if (sdp872_parameters->values != NULL)
			{
				sdp872_parameters->type = MafOamSpiMoAttributeType_3_STRUCT;
				...
				sdp872_parameters->values[1].value.structMember = new MafMoAttributeValueStructMember_3T;
				memset(sdp872_parameters->values[1].value.structMember, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				sdp872_parameters->values[1].value.structMember->memberValue = new MafMoAttributeValueContainer_3;
				...
				sdp872_parameters->values[1].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				sdp872_parameters->values[1].value.structMember->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				sdp872_parameters->values[1].value.structMember->next = new MafMoAttributeValueStructMember_3T;
				memset(sdp872_parameters->values[1].value.structMember->next, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				sdp872_parameters->values[1].value.structMember->next->memberValue = new MafMoAttributeValueContainer_3;
				...
				sdp872_parameters->values[1].value.structMember->next->memberValue->type = MafOamSpiMoAttributeType_3_INT32;

				sdp872_parameters->values[1].value.structMember->next->memberValue->values = new MafMoAttributeValue_3T[1];
		...
		if (sdp872_parameters != NULL)
		{
			...
			if (sdp872_parameters->values != NULL)
			{
				...
				sdp872_parameters->values[1].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				sdp872_parameters->values[1].value.structMember->memberValue->values = new MafMoAttributeValue_3[3];
				...
				sdp872_parameters->values[1].value.structMember->next->memberValue->values = new MafMoAttributeValue_3T[4];
				...
				sdp872_parameters->values[2].value.structMember = new MafMoAttributeValueStructMember_3T;
				memset(sdp872_parameters->values[2].value.structMember, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				sdp872_parameters->values[2].value.structMember->memberValue = new MafMoAttributeValueContainer_3;
				...
				sdp872_parameters->values[2].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				sdp872_parameters->values[2].value.structMember->memberValue->values = new MafMoAttributeValue_3[3];
				...
				sdp872_parameters->values[2].value.structMember->next = new MafMoAttributeValueStructMember_3T;
				memset(sdp872_parameters->values[2].value.structMember->next, 0, sizeof(MafMoAttributeValueStructMember_3T));
				if( sdp872_parameters->values[2].value.structMember->next == NULL) {
					delete []cont_parameters;
					return MafFailure;
				}

				sdp872_parameters->values[2].value.structMember->next->memberValue = new MafMoAttributeValueContainer_3;
				...
				sdp872_parameters->values[2].value.structMember->next->memberValue->type = MafOamSpiMoAttributeType_3_INT32;

				sdp872_parameters->values[2].value.structMember->next->memberValue->values = new MafMoAttributeValue_3T[4];
	...
	//BEGIN MR24146 UC2 changes - return values to COM
		...
		mr24146_parameters = new MafMoAttributeValueContainer_3T;

		if (mr24146_parameters != NULL)
		{
			mr24146_parameters->values 				= new MafMoAttributeValue_3T[1];
			if (mr24146_parameters->values != NULL)
			{

				mr24146_parameters->type = MafOamSpiMoAttributeType_3_DECIMAL64;
		...
		if (mr24146_parameters != NULL)
		{
			mr24146_parameters->values 				= new MafMoAttributeValue_3T[3];
			if (mr24146_parameters->values != NULL)
			{
				mr24146_parameters->type = MafOamSpiMoAttributeType_3_DECIMAL64;
		...
		if (mr24146_parameters != NULL)
		{
			...
			if (mr24146_parameters->values != NULL)
			{
				mr24146_parameters->type = MafOamSpiMoAttributeType_3_STRUCT;
				mr24146_parameters->nrOfValues = 1;

				mr24146_parameters->values[0].value.structMember = new MafMoAttributeValueStructMember_3T;
				memset(mr24146_parameters->values[0].value.structMember, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				mr24146_parameters->values[0].value.structMember->memberValue = new MafMoAttributeValueContainer_3;
				...
				mr24146_parameters->values[0].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				mr24146_parameters->values[0].value.structMember->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				mr24146_parameters->values[0].value.structMember->next = new MafMoAttributeValueStructMember_3T;
				memset(mr24146_parameters->values[0].value.structMember->next, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				mr24146_parameters->values[0].value.structMember->next->memberValue = new MafMoAttributeValueContainer_3;
				...
				mr24146_parameters->values[0].value.structMember->next->memberValue->type = MafOamSpiMoAttributeType_3_DECIMAL64;

				mr24146_parameters->values[0].value.structMember->next->memberValue->values = new MafMoAttributeValue_3T[1];
		...
		if (mr24146_parameters != NULL)
		{
			mr24146_parameters->values 				= new MafMoAttributeValue_3T[2];
			if (mr24146_parameters->values != NULL)
			{
				mr24146_parameters->type = MafOamSpiMoAttributeType_3_STRUCT;
				...
				//Populate structure B
				mr24146_parameters->values[1].value.structMember = new MafMoAttributeValueStructMember_3T;
				memset(mr24146_parameters->values[1].value.structMember, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				mr24146_parameters->values[1].value.structMember->memberValue = new MafMoAttributeValueContainer_3;
				...
				mr24146_parameters->values[1].value.structMember->memberValue->type = MafOamSpiMoAttributeType_3_STRING;
				mr24146_parameters->values[1].value.structMember->memberValue->values = new MafMoAttributeValue_3T[1];
				...
				mr24146_parameters->values[1].value.structMember->next = new MafMoAttributeValueStructMember_3T;
				memset(mr24146_parameters->values[1].value.structMember->next, 0, sizeof(MafMoAttributeValueStructMember_3T));
				...
				mr24146_parameters->values[1].value.structMember->next->memberValue = new MafMoAttributeValueContainer_3;
				...
				mr24146_parameters->values[1].value.structMember->next->memberValue->type = MafOamSpiMoAttributeType_3_DECIMAL64;

				mr24146_parameters->values[1].value.structMember->next->memberValue->values = new MafMoAttributeValue_3T[1];
	...
	*/
	...
	MafOamSpiMoAttributeType_3T actionParamType;
	...
	default:
		syslog(LOG_INFO, "%s MO::maf_action() type not found, returning MafFailure",log_prefix);
...
MafReturnT maf_finalizeMoIterator(MafOamSpiMoIteratorHandle_3T itHandle)
{
...
MafReturnT maf_existsMo(MafOamSpiTransactionHandleT txHandle, const char * dn, bool * result)
{
...
MafReturnT maf_countMoChildren(MafOamSpiTransactionHandleT txHandle, const char * dn, const char * className, uint64_t * result)
{
...
***************************************************************************************************************
*
*  MafOamSpiTransactionalResource_2T interface functions
*
***************************************************************************************************************
***************************************************************************************************************
***************************************************************************************************************/
...
MafReturnT join (MafOamSpiTransactionHandleT txHandle)
{
	...
	MafReturnT returnValue = _transactionIf->registerParticipant(txHandle, &transactionalResourceIf);
	...
	*/
	...
	if(returnValue != MafOk)
	{
		...
		// if returnValue of join() is not MafOk, this will give same condition as saImmOmCcbObjectCreate() returning != SA_AIS_OK
		// and to confirm this ccb is aborted afterwards, check for hs99358_ccb_has_been_aborted flag_mr20275
		// If it has been overridden, return MafOk
...
MafReturnT prepare (MafOamSpiTransactionHandleT txHandle)
{
	...
	*                    -or a negative testcase where we especially set the return value other then MafOk
	*/
	MafReturnT returnValue = testConfig->getReturnValue("prepare");
	// If retValue not MafOk then write return value to syslog
	if(returnValue != MafOk)
	{
		setAllReturnValuesToFail();
...
MafReturnT commit (MafOamSpiTransactionHandleT txHandle)
{
	...
	if (!validate_mr20275)
	{
		syslog(LOG_INFO, "%s TR::commit(): returning MafFailure",log_prefix);
	...
	{
		syslog(LOG_INFO, "%s TR::commit(): returning MafOk",log_prefix);
		return MafOk;
	}
	/* If a preconfigured return value is already set, then return that value instead of MafOk.
	* That means it is:
	...
	*                    -or a negative testcase where we especially set the return value other then MafOk
	*/
	MafReturnT returnValue = testConfig->getReturnValue("commit");
	// If retValue not MafOk then write return value to syslog
	if(returnValue != MafOk)
	{
		setAllReturnValuesToFail();
...
MafReturnT abort (MafOamSpiTransactionHandleT txHandle)
{
	...
	*/
	...
	MafReturnT returnValue = testConfig->getReturnValue("abort");
	// If retValue not MafOk then write return value to syslog
	if(returnValue != MafOk)
	{
		setAllReturnValuesToFail();
...
MafReturnT finish (MafOamSpiTransactionHandleT txHandle)
{
	...
	*                    -or a negative testcase where we especially set the return value other then MafOk
	*/
	MafReturnT returnValue = testConfig->getReturnValue("finish");
	...
	else
	{
		...
		syslog(LOG_INFO, "%s TR::finish(): returning MafOk",log_prefix);
	}
	return returnValue;
}
...
MafReturnT validate(MafOamSpiTransactionHandleT txHandle, bool *result)
{
	...
	if (!validate_mr20275)
	{
		syslog(LOG_INFO, "%s TR::validate(): returning MafFailure",log_prefix);
		return MafFailure;
	}
	else
	{
		syslog(LOG_INFO, "%s TR::validate(): returning MafOk",log_prefix);
		return MafOk;
	}
	...
	*                    -or a negative testcase where we especially set the return value other then MafOk
	*/
	MafReturnT returnValue = testConfig->getReturnValue("validate");
...
MafReturnT registerAsOIToOamSA(std::string DN_or_MOC, OIaction registration, std::string permission)
{
	...
	case REGISTER_DN_INSTANCE:
		...
		ret = _registerObjectImplementerIf->registerDn( component_name, DN_or_MOC.c_str());
	...
	case REGISTER_CLASS:
		...
		ret = _registerObjectImplementerIf->registerClass( component_name, cleaned_DN_or_MOC.c_str());
		if(ret == MafOk)
		{
	...
	case UNREGISTER_DN:
		...
		ret = _registerObjectImplementerIf->unregisterDn( component_name, DN_or_MOC.c_str());
		if(ret == MafOk)
		{
	...
	case UNREGISTER_CLASS:
		...
		// class registration needs special action: remove exclusive key attributes from MOC
		cleaned_DN_or_MOC = removeKeyAttributes(DN_or_MOC);
		ret = _registerObjectImplementerIf->unregisterClass( component_name, cleaned_DN_or_MOC.c_str());
		if(ret == MafOk)
		{
	...
	default:
		syslog(LOG_INFO, "%s ENTER default case MafInvalidArgument in function registerAsOIToOamSA",log_prefix);
		return MafInvalidArgument;
	}
}

MafReturnT loadMocOrDnConfig(std::string DN_or_MOC, std::string DN_PERMISSION)
{
	OIaction regType;
...
void loadAttributeConfig(std::string ATTR, MafOamSpiMoAttributeType_3T ATTR_TYPE, std::string ATTR_VALUE)
{
...
void loadActionTestConfig(std::string ACTION, MafOamSpiMoAttributeType_3T ACTION_TYPE)
{
...
extern "C" MafReturnT maf_start(MafStateChangeReasonT reason)
{
	...
	ret = _portal->getInterface(MafOamSpiRegisterObjectImplementer_3Id, (MafMgmtSpiInterface_1T**) &_registerObjectImplementerIf);
	if (ret != MafOk)
	{
		syslog(LOG_ERR,"%s maf_start(): failed(%i) to get '%s' interface",log_prefix, ret, MafOamSpiRegisterObjectImplementer_3Id.interfaceName);
		return (MafReturnT)ret;
	}
	else if (!_registerObjectImplementerIf)
	{
		syslog(LOG_ERR,"%s maf_start(): failed to get '%s' interface, NULL returned",log_prefix, MafOamSpiRegisterObjectImplementer_3Id.interfaceName);
		return MafFailure;
	}

	// Get Thread Context interface
	maf_return = _portal->getInterface(MafMgmtSpiThreadContext_2Id, (MafMgmtSpiInterface_1T**) &_threadContextIf);
	if (MafOk != maf_return)
	{
	...
	ret = _portal->getInterface(MafOamSpiTransaction_2Id, (MafMgmtSpiInterface_1T**) &_transactionIf);
	if (ret != MafOk)
	{
		syslog(LOG_ERR,"%s maf_start(): failed(%i) to get MafOamSpiTransaction_2T interface",log_prefix,ret);
		return(MafReturnT) ret;
	}
	else if (!_transactionIf)
	{
		syslog(LOG_ERR,"%s maf_start(): failed to get '%s' interface, NULL returned",log_prefix, MafOamSpiTransaction_2Id.interfaceName);
		return MafFailure;
	}
...
#if defined (ALARMS) || defined (CM_EVENT_CONSUMER) || defined (ALARMS4)
	{
		...
		MafReturnT ret_MAF = _portal->getInterface(MafOamSpiEventService_1Id, (MafMgmtSpiInterface_1T**) &_eventRouter);
		if (ret_MAF != MafOk)
		{
...
#if defined (LOGSERVICE)
	{
		// Get interface
		MafReturnT ret;
		ret = _portal->getInterface(MafMwSpiLog_1Id, (MafMgmtSpiInterface_1T**) &_logServiceIf);
...
#if defined (TRACESERVICE)
	{
		// Get interface
		MafReturnT ret;
		ret = _portal->getInterface(MafMwSpiTrace_1Id, (MafMgmtSpiInterface_1T**) &_traceServiceIf);
...
#if defined (maf_returnValueConfig)
	{
		// Create a structure of return values
		functionReturnValues returnValues;
...
void maf_initComponent()
{
	...
	component.base.interfaceName = "MafMgmtSpiComponent";
	component.base.interfaceVersion = "2";

	dependencyArray[0] = 0;

	managedObjectIf.base.componentName    = component.base.componentName;
	managedObjectIf.base.interfaceName    = MafOamSpiManagedObject_3Id.interfaceName;
	managedObjectIf.base.interfaceVersion = MafOamSpiManagedObject_3Id.interfaceVersion;
	...
	transactionalResourceIf.base.interfaceName = MafOamSpiTransactionalResource_2Id.interfaceName;
	transactionalResourceIf.base.interfaceVersion = MafOamSpiTransactionalResource_2Id.interfaceVersion;
	...
	interfaceArray[0] = (MafMgmtSpiInterface_1T*)&managedObjectIf;
	interfaceArray[0]->componentName = component.base.componentName;
	interfaceArray[1] = (MafMgmtSpiInterface_1T*)&transactionalResourceIf;
	interfaceArray[1]->componentName = component.base.componentName;
	interfaceArray[2] = 0;

	component.interfaceArray  = (MafMgmtSpiInterface_1T **)interfaceArray;
	component.dependencyArray = (MafMgmtSpiInterface_1T **)dependencyArray;
	static MafMgmtSpiInterface_1T* maf_optarray[] =  { NULL };
	component.start = &maf_start;
	component.stop  = &maf_stop;
	component.optionalDependencyArray  =  (MafMgmtSpiInterface_1T **) maf_optarray;
}
...
extern "C" MafReturnT mafLCMinit(MafMgmtSpiInterfacePortalAccessorT* accessor, const char* config)
{
	...
	_portal = (MafMgmtSpiInterfacePortal_3T*)accessor-> getPortal("3");
	assert(_portal);
	_portal = (MafMgmtSpiInterfacePortal_3T*)accessor-> getPortal("3");
	assert(_portal);

	ret = (MafReturnT) _portal->registerComponent(&component);
	if (ret != MafOk) {
