...
public:
	...
	ComReturnT getRegistration(ComMgmtSpiThreadContext_2T*, const char*, const char* = 0, const char* = 0);
//SDP1694 - support MAF SPI 
	ComReturnT maf_getRegistration(MafMgmtSpiThreadContext_2T*, const char*, const char* = 0, const char* = 0);
	...
	ComReturnT getReturnValue(std::string);


	// Action test configurations
	void addAction(std::string, ComOamSpiMoAttributeType_3T);
	ComOamSpiMoAttributeType_3T getAction(const char*, const char*);
