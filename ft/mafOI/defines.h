 ...
 *                    -test negative cases where some(or all) of the return values especially set other then ComOk.
 *
 */
#define returnValueConfig returnValues.createMo = ComOk; returnValues.deleteMo = ComOk; returnValues.setMo = ComFailure; returnValues.getMo = ComFailure; returnValues.action = ComOk; returnValues.join = ComOk; returnValues.prepare = ComOk; returnValues.commit = ComOk; returnValues.finish = ComOk; returnValues.abort = ComOk;
...
#define ATTR11_TYPE ComOamSpiMoAttributeType_3_STRUCT
...
#define ATTR12_TYPE ComOamSpiMoAttributeType_3_STRUCT
...
#define ACTION1_TYPE ComOamSpiMoAttributeType_3_STRING
