...
public class B_JavaLibrary extends OmpLibrary implements TestLibrary {
    OmpSut sut;
    ...
    public B_JavaLibrary(final OmpSut sut) {
        this.sut = sut;
    }
    ...
    public String[] getRuntimeDependencies() {
        return new String[] { "C_JavaLibrary" };
    }
    ...
    public void aMethodToBeCalledFromAnotherLibrary() {
