...
public class A_JavaLibrary extends OmpLibrary implements TestLibrary {
    OmpSut sut;
    ...
    public A_JavaLibrary(final OmpSut sut) {
        this.sut = sut;
    }
    ...
    public String[] getRuntimeDependencies() {
        return new String[] { "B_JavaLibrary" };
    }
