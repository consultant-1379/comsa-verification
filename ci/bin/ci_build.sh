...
if ( $BUILD_TYPE == "SN" ) then
  ...
  ci_build_copy.sh ${COMSA_BRANCH}-${MAJOR_VERSION}_SH${RELEASE_VERSION}-${BUILD_TYPE}${BUILD_TIME}
...
# Shipments
  ...
  ci_build_copy.sh ${COMSA_BRANCH}-${MAJOR_VERSION}_${BUILD_TYPE}${RELEASE_VERSION}
