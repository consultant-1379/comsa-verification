...
if ( -f /etc/SuSE-release ) then
    ...
    setenv JYTHONPATH ${MY_REPOSITORY}:$CMW_TOOLS/JCAT/3PP/LM_JCATFW-JCatFw/scripts/jython:$JCAT_OMP_EXTENSIONS/target/main/python/:$JCAT_OMP_CORE_MW/target/main/python:$JCAT_OMP_EXTENSIONS/target/main/classes:/home/tspsaf/public_html/test_env/targetconf/lib:/home/tspsaf/tools/Jython/Lib
